...
//
	leaffaces += count;
	leafnode->markfaces = /*/S&F*****/(face_t**)/*/S&F*****/malloc(sizeof(face_t *)*(count+1));
	i = 0;
...
{
	face_t	*f, */*/S&F*****new*/newface, **prevptr;
	face_t	*list;
...
// copy
	...
	{
		nodefaces++;
		/*/S&F*****new*/newface/*/S&F*****/ = AllocFace ();
		*/*/S&F*****new*/newface/*/S&F*****/ = *f;
		f->original = /*/S&F*****new*/newface/*/S&F*****/;
		/*/S&F*****new*/newface/*/S&F*****/->next = list;
		list = /*/S&F*****new*/newface/*/S&F*****/;
	}
