...
{
	/*/S&F*****int*/long long			size;
	winding_t	*c;
	
	size = (/*/S&F*****int*/long long)((winding_t *)0)->points[w->numpoints];
	c = /*/S&F*****/(winding_t*)/*/S&F*****/malloc (size);
	memcpy (c, w, size);
	return c;
}
...
winding_t *NewWinding (int points)
{
	...
	size = (/*/S&F*****int*/long long)((winding_t *)0)->points[points];
	w = /*/S&F*****/(winding_t*)/*/S&F*****/malloc (size);
	memset (w, 0, size);
...
face_t *AllocFace (void)
{
	...
	f = /*/S&F*****/(face_t*)/*/S&F*****/malloc (sizeof(face_t));
...
surface_t *AllocSurface (void)
{
	...
	s = /*/S&F*****/(surface_t*)/*/S&F*****/malloc (sizeof(surface_t));
...
portal_t *AllocPortal (void)
{
	...
	p = /*/S&F*****/(portal_t*)/*/S&F*****/malloc (sizeof(portal_t));
...
node_t *AllocNode (void)
{
	...
	n = /*/S&F*****/(node_t*)/*/S&F*****/malloc (sizeof(node_t));
...
brush_t *AllocBrush (void)
{
	...
	b = /*/S&F*****/(brush_t*)/*/S&F*****/malloc (sizeof(brush_t));
