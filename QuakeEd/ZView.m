...
//	[superview setDrawOrigin: 0 : 0];
	...
	pt.x = -/*/S&F*****/self./*/S&F*****/bounds.size.width;
	pt.y = -128;
...
- drawGrid: (const NXRect *)rect
{
	...
	left = /*/S&F*****/self./*/S&F*****/bounds.origin.x;
	right = 24;
...
// divider
	UPmoveto (upath, 0, /*/S&F*****/self./*/S&F*****/bounds.origin.y);
	UPlineto (upath, 0, /*/S&F*****/self./*/S&F*****/bounds.origin.y + /*/S&F*****/self./*/S&F*****/bounds.size.height);
