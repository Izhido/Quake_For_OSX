...
- initVars
{
	...
	self = /*/S&F*****/[self initProjSettings];
...
- initProjSettings
{
	[pis_basepath_i	/*/S&F*****setStringValue*/setStringValueAsString:path_basepath];
	[pis_fullvis_i	/*/S&F*****setStringValue*/setStringValueAsString:string_fullvis];
	[pis_fastvis_i	/*/S&F*****setStringValue*/setStringValueAsString:string_fastvis];
	[pis_novis_i	/*/S&F*****setStringValue*/setStringValueAsString:string_novis];
	[pis_relight_i	/*/S&F*****setStringValue*/setStringValueAsString:string_relight];
	[pis_leaktest_i	/*/S&F*****setStringValue*/setStringValueAsString:string_leaktest];
...
// set the row in the settings inspector wad browser
	...
	for (i=0 ; i<c ; i++)
	{
		...
		if (!strcmp(name, wf))
		{
            [[pis_wads_i matrixInColumn:0] selectCellAtRow:i column:0];//S&F*****selectCellAt: i : 0];
			break;
		}
	}
...
- openProject
{
	...
	rtn = [openpanel /*/S&F*****runModalForTypes*/runModalForTypesAsStringList:projtypes];
	if (rtn == NX_OKTAG)
	{
		 /*/S&F*****(const char *const *)*/filenames = [openpanel /*/S&F*****filenames*/filenamesAsStringList];
		 dir = (char *)[openpanel /*/S&F*****directory*/directoryAsString];
