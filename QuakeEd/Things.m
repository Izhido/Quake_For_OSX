...
{	
	...
	[prog_path_i /*/S&F*****setStringValue*/setStringValueAsString: path];
...
- reloadEntityClasses: sender
{
	...
	path = (char *)[prog_path_i /*//S&F*****stringValue*/stringValueAsString];
	if (!path || !path[0])
	{
		path = [project_i getProgDirectory];
		[prog_path_i /*/S&F*****setStringValue*/setStringValueAsString: path];
...
- selectClass: (char *)class
{
	...
	[[entity_browser_i matrixInColumn:0] selectCellAtRow:lastSelected column:0];//S&F*****selectCellAt:lastSelected :0];
    [[entity_browser_i matrixInColumn:0] scrollCellToVisibleAtRow:lastSelected column:0];//S&F*****scrollCellToVisible:lastSelected :0];
...
{
	[keyInput_i /*/S&F*****setStringValue*/setStringValueAsString:ep->key];
	[valueInput_i /*/S&F*****setStringValue*/setStringValueAsString:ep->value];
...
-addPair:sender
{
	...
	key = (char *)[keyInput_i /*//S&F*****stringValue*/stringValueAsString];
	value = (char *)[valueInput_i /*//S&F*****stringValue*/stringValueAsString];
...
-delPair:sender
{
	...
	[ [map_i currentEntity] removeKeyPair: (char *)[keyInput_i /*//S&F*****stringValue*/stringValueAsString] ];
...
- setAngle:sender
{
	...
	[keyInput_i /*/S&F*****setStringValue*/setStringValueAsString:"angle"];
	[valueInput_i /*/S&F*****setStringValue*/setStringValueAsString:value];
	[self addPair:NULL];
